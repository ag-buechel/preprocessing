...
pm_def.INPUT_DATA_FORMAT = 'PM';      % 'RI' = load two real and
                                      ...
                                      % pairs.
pm_def.SHORT_ECHO_TIME = 4.62;        % Short echo time in ms
pm_def.LONG_ECHO_TIME  = 7.08;        % Long echo time in ms
...
pm_def.K_SPACE_TRAVERSAL_BLIP_DIR = -1; % A>>P
pm_def.TOTAL_EPI_READOUT_TIME = 33;     % EPI RO time (0.66*150/3)
